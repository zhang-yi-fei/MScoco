...
dataset = HeatmapDataset(coco_keypoint, coco_caption, text_model=text_model, full_image=True)
dataset_val = HeatmapDataset(coco_keypoint_val, coco_caption_val, text_model=text_model, full_image=True)
...
net_d.train()
iteration = 1
writer = SummaryWriter(comment='_full')
...
for e in range(epoch):
    ...
    # print and log
    print('epoch ' + str(e + 1) + ' of ' + str(epoch) + ' val g loss: ' + str(
