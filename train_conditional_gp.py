...
torch.save(net_g.state_dict(), generator_path + '_' + f'{start_from_epoch + 1:05d}' + '_new')
torch.save(net_d.state_dict(), discriminator_path + '_' + f'{start_from_epoch + 1:05d}' + '_new')
